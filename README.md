...
- **v1.4.4 Theme Switcher:** navbar, starter templates, and the theme-switcher live demo use the framework **menu variant** (icon toggle opens a picker; no cycle-on-click). Docs omit optional `data-tooltip` on the switcher; the framework supports tooltips when consumers opt in.
